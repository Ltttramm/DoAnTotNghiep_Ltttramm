...
//            WeightPredictions = new HashSet<WeightPrediction>();
//            WeightTrackings = new HashSet<WeightTracking>();
//            // THÊM DÒNG NÀY: Khởi tạo danh sách yêu thích
...
//        // THÊM ĐOẠN NÀY: Thuộc tính điều hướng cho danh sách yêu thích
//        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
...
namespace WebsiteQuanLyDinhDuongCaNhan.Models
{
    ...
    public partial class User
    {
        ...
        {
            UserFavorites = new HashSet<UserFavorite>();
            UserMeals = new HashSet<UserMeal>();  // ✅ THÊM DÒNG NÀY
        }
        ...
        // ✅ SỬA DÒNG NÀY - Đổi từ ICollection<object> thành ICollection<UserMeal>
        public virtual ICollection<UserMeal> UserMeals { get; set; }
        public virtual ICollection<UserFavorite> UserFavorites { get; set; }
